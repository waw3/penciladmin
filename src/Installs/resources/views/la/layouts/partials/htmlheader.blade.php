<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ PAConfigs::getByKey('sitename') }}</title>
    ...
    -->
    <link href="{{ asset('pa-assets/css/skins/'.PAConfigs::getByKey('skin').'.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
