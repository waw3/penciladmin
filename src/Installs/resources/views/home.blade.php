...
<head>
    ...
    <link href="{{ asset('/pa-assets/css/main.css') }}" rel="stylesheet">

    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Raleway:400,300,700' rel='stylesheet' type='text/css'>

    <script src="{{ asset('/pa-assets/plugins/jQuery/jQuery-2.1.4.min.js') }}"></script>
    <script src="{{ asset('/pa-assets/js/smoothscroll.js') }}"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li><a href="{{ url(config('penciladmin.adminRoute')) }}">{{ Auth::user()->name }}</a></li>
                @endif
            </ul>
        </div><!--/.nav-collapse -->
    </div>
    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-2">
                ...
                <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/pa-assets/img/arrow1.png') }}">
            </div>
            <div class="col-lg-8">
                <img class="img-responsive" src="{{ asset('/pa-assets/img/app-bg.png') }}" alt="">
            </div>
            <div class="col-lg-2">
                <br>
                <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/pa-assets/img/arrow2.png') }}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 centered">
                <img class="centered" src="{{ asset('/pa-assets/img/mobile.png') }}" alt="">
            </div>

            <div class="col-lg-7">
				<h3 class="feature-title">What is PencilAdmin ?</h3><br>
				<ol class="features">
				...
				<h3 class="feature-title">Why PencilAdmin ?</h3><br>
                <ol class="features">
					<li><strong>Philosophy:</strong> Inspired by SugarCRM &amp; based on Advanced <strong>Data Types</strong> like Image, HTML, File, Dropdown, TagInput which makes developers job easy. See more in <a target="_blank" href="http://penciladmin.com/features">features</a></li>
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
			...
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:hello@penciladmin.com">hello@penciladmin.com</a></div>
			<div class="contact-link"><i class="fa fa-cube"></i> <a href="http://penciladmin.com">penciladmin.com</a></div>
			<div class="contact-link"><i class="fa fa-building"></i> <a href="http://krackenlabs.io">krackenlabs.io</a></div>
        </div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2016. Powered by <a href="https://waw3itsolutions.com"><b>Waw3 IT Solutions</b></a>
        </p>
    </div>
</div>
...
<script src="{{ asset('/pa-assets/js/bootstrap.min.js') }}" type="text/javascript"></script>
<script>
    $('.carousel').carousel({
        interval: 3500
    })
