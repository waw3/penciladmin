...
<div class="box">
	...
	<div class="box-body">
		...
		<pre><code>composer require waw/pencileditor</code></pre>
		<p>This will download the editor package. Not install editor by following command:</p>
		<pre><code>php artisan pa:editor</code></pre>
		<p>Now refresh this page or go to <a href="{{ url(config('penciladmin.adminRoute') . '/pencileditor') }}">{{ url(config('penciladmin.adminRoute') . '/pencileditor') }}</a>.</p>
	</div>
</div>
