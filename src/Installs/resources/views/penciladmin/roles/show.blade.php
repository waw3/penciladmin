...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-3">
					<!--<img class="profile-image" src="{{ asset('pa-assets/img/avatar5.png') }}" alt="">-->
		...
		<div class="col-md-1 actions">
			@pa_access("Roles", "edit")
				<a href="{{ url(config('penciladmin.adminRoute') . '/roles/'.$role->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endpa_access

			@pa_access("Roles", "delete")
				{{ Form::open(['route' => [config('penciladmin.adminRoute') . '.roles.destroy', $role->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('penciladmin.adminRoute') . '/roles') }}" data-toggle="tooltip" data-placement="right" title="Back to Roles"><i class="fa fa-chevron-left"></i></a></li>
	...
	<div class="tab-content">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@pa_display($module, 'display_name')
						@pa_display($module, 'description')
						@pa_display($module, 'parent')
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			...
			<form action="{{ url(config('penciladmin.adminRoute') . '/save_module_role_permissions/'.$role->id) }}" method="post">
