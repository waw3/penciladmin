<script src="{{ asset('pa-assets/plugins/dropzone/dropzone.js') }}"></script>
				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="fm_folder_selector">
							<form action="{{ url(config('penciladmin.adminRoute') . '/upload_files')}}" id="fm_dropzone" enctype="multipart/form-data" method="POST">
								{{ csrf_field() }}
								...
								@if(!config('penciladmin.uploads.private_uploads'))
									...
									{{ Form::checkbox("public", "public", config("penciladmin.uploads.default_public"), []) }}
