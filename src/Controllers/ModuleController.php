...
class ModuleController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $modules = Module::all();
        return redirect()->route(config('penciladmin.adminRoute') . '.modules.index', ['modules' => $modules]);
    }
    ...
    public function save_role_module_permissions(Request $request, $id)
    {
        ...
        return redirect(config('penciladmin.adminRoute') . '/modules/' . $id . "#access");
    }
    ...
    /**
     * Get Array of all Module Files generated by PencilAdmin
     *
     * @param Request $request
     * @param $module_id Module ID
     * @return \Illuminate\Http\JsonResponse
