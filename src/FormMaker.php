...
class FormMaker
{
        ...
        if(Module::hasFieldAccess($module->id, $module->fields[$field_name]['id'], $access_type = "write")) {
            ...
            switch($field_type->name) {
                ...
                case 'Dropdown':
                    ...
                    if($popup_vals != "") {
                        $popup_vals = FormMaker::process_values($popup_vals);
                    } else {
                        $popup_vals = array();
                    }
                ...
                case 'Taginput':
                    ...
                    $default_val = FormMaker::process_values($default_val);
     ...
     **/
    // $values = FormMaker::process_values($data);
        ...
        if(Module::hasFieldAccess($module->id, $module->fields[$field_name]['id'], $access_type = "view")) {
            ...
            switch($field_type->name) {
                ...
                case 'Decimal':
                    ...
                    break;
                case 'Dropdown':
                    $values = FormMaker::process_values($fieldObj['popup_vals']);
    ...
    public static function form($module, $fields = [])
    {
        ...
        foreach($fields as $field) {
            ...
            $out .= FormMaker::input($module, $field);
        }
        return $out;
    }
